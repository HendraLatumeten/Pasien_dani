<?php
    ...
    session_start();
    $sql = "SELECT Null `no`, Null idagama, Null namaagama From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `no`, idagama, namaagama From agama a, "
        . "(Select @row := 0) p";
    $sQuery1 .= ") a";
    $sQuery1 .= " $sWhere
        $sOrder
    ...
    $sQuery = "Select Count(p.idagama) Jml From (Select @row := @row+1 `no`, idagama, namaagama From agama a, "
        . "(Select @row := 0) p) p ";
    $sQuery .= " $sWhere";
