<?php
    ...
    session_start();
    $sql = "SELECT Null `No`, Null idtempat, Null namatempat, Null Action From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `No`, idtempat, namatempat, idtempat Action From tempattinggal a, "
        . "(Select @row := 0) p";
    $sQuery1 .= ") a";
    $sQuery1 .= " $sWhere
        $sOrder
    ...
    $sQuery = "Select Count(p.idtempat) Jml From (Select @row := @row+1 `No`, idtempat, namatempat, "
        . "idtempat Action From tempattinggal a, (Select @row := 0) p) p ";
    $sQuery .= " $sWhere";
