<?php
    ...
    session_start();
    $sql = "SELECT Null `No`, Null idgroup, Null namagroup, Null keterangangroup, Null Action From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `No`, idgroup, namagroup, keterangangroup, idgroup Action "
        . "From groupuser a, "
        . "(Select @row := 0) p";
    $sQuery1 .= ") a";
    $sQuery1 .= " $sWhere
    ...
    $sQuery = "Select Count(p.idgroup) Jml From (Select @row := @row+1 `No`, idgroup, namagroup, "
        . "keterangangroup, idgroup Action From groupuser a, (Select @row := 0) p) p ";
    $sQuery .= " $sWhere";
