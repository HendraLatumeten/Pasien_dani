<?php
    ...
    $sql = "Select Null `no`, Null idterima, Null kodeterima, Null tanggalterima, Null nama, Null nisn "
        . "From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `no`, idterima, kodeterima, tanggalterima, "
        . "Concat(namadepan, ' ', namabelakang) nama, nisn "
        . "From penerimaan d, (Select @row := 0) p Where tanggalterima "
    ...
    $sQuery = "Select Count(p.idterima) Jml From (Select @row := @row+1 `no`, idterima, kodeterima, tanggalterima, "
        . "Concat(namadepan, ' ', namabelakang) nama, nisn "
        . "From penerimaan d, (Select @row := 0) p Where tanggalterima "
        . "between '$tglawal' and '$tglakhir') p ";
    $sQuery .= " $sWhere";
