<?php
    ...
    session_start();
    $sql = "SELECT Null `no`, Null idkelamin, Null namakelamin From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `no`, idkelamin, namakelamin From kelamin k, "
        . "(Select @row := 0) p";
    $sQuery1 .= ") a";
    $sQuery1 .= " $sWhere
        $sOrder
    ...
    $sQuery = "Select Count(p.idkelamin) Jml From (Select @row := @row+1 `no`, idkelamin, namakelamin From kelamin k, "
        . "(Select @row := 0) p) p ";
    $sQuery .= " $sWhere";
