<?php
    ...
    session_start();
    $sql = "SELECT Null `No`, Null idhasil, Null namahasil, Null Action From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `No`, idhasil, namahasil, idhasil Action From penghasilan a, "
        . "(Select @row := 0) p";
    $sQuery1 .= ") a";
    $sQuery1 .= " $sWhere
        $sOrder
    ...
    $sQuery = "Select Count(p.idhasil) Jml From (Select @row := @row+1 `No`, idhasil, namahasil, "
        . "idhasil Action From penghasilan a, (Select @row := 0) p) p ";
    $sQuery .= " $sWhere";
