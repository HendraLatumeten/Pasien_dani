<?php
    ...
    session_start();
    $sql = "SELECT Null `No`, Null idlembaga, Null namalembaga, Null keteranganlembaga, Null Action From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `No`, idlembaga, namalembaga, keteranganlembaga, idlembaga Action "
        . "From lembaga a, "
        . "(Select @row := 0) p";
    $sQuery1 .= ") a";
    $sQuery1 .= " $sWhere
    ...
    $sQuery = "Select Count(p.idlembaga) Jml From (Select @row := @row+1 `No`, idlembaga, namalembaga, "
        . "keteranganlembaga, idlembaga Action From lembaga a, (Select @row := 0) p) p ";
    $sQuery .= " $sWhere";
