<?php
    ...
    session_start();
    $sql = "SELECT Null `No`, Null idkerja, Null namakerja, Null Action From Dual Limit 0, 0";
    ...
    * Get Where DataTables
    ...
    $sQuery1 = "
        ...
        FROM (";
    $sQuery1 .= "Select @row := @row+1 `No`, idkerja, namakerja, idkerja Action From pekerjaan a, "
        . "(Select @row := 0) p";
    $sQuery1 .= ") a";
    $sQuery1 .= " $sWhere
        $sOrder
    ...
    $sQuery = "Select Count(p.idkerja) Jml From (Select @row := @row+1 `No`, idkerja, namakerja, "
        . "idkerja Action From pekerjaan a, (Select @row := 0) p) p ";
    $sQuery .= " $sWhere";
