            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Laporan Penolakan</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Laporan Penolakan</h3>
                                </div>
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                datalapterima = $("#datalapterima").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/datalaptolak.php",
                ...
                function(start, end) {
                    ...
                    jQuery("div.toolbar").html('<b><center>LAPORAN PENOLAKAN</center></b>'+
                            '<br>'+
