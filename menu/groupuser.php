                        ...
                        <div class="col-md-5">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Entri Data Group User</h3>
                                </div>
                                <div class="box-body">
                                    <form id="groupform" name="groupform" role="form" class="form-horizontal"
                                        method="post" action="data/simpangroup.php?act=new" novalidate="novalidate">
                                        <div class="form-group">
                                            <label for="idgroup" class="col-md-4 control-label">Id Group</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="idgroup" name="idgroup"
                                                    placeholder="Id Group" readonly value="<?php echo $no?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="namagroup" class="col-md-4 control-label">Nama Group</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label for="keterangangroup" class="col-md-4 control-label">Keterangan Group</label>
                                            <div class="col-md-8">
                                                <textarea type="text" class="form-control" id="keterangangroup" name="keterangangroup"
                                                    placeholder="Keterangan Group" rows="3"></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="datagroup" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="center" style="width: 10%">No</th>
                                                <th class="center" style="width: 15%">Id Group</th>
                                                <th style="width: 38%">Nama Group</th>
                                                <th style="width: 25%">Keterangan Group</th>
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                function No(){
                    ...
                    $.ajax({
                        dataType: 'json',
                        url: "data/maxgroup.php",
                        type: "GET",
                        success: function(data){
                            $.each(data, function(i, n){
                                var group1 = n["idgroup"];
                                idgroup.value = group1;
                            });
                        },
                        failure: function(){
                ...
                datagroup = $("#datagroup").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/datagroup.php",
                    "oLanguage": {
                    ...
                    "aoColumns": [
                        ...
                        {"bSortable": false, "sClass": "center", "mData": "idgroup"},
                        {"bSortable": false, "mData": "namagroup"},
                        {"bSortable": false, "mData": "keterangangroup"},
                        {"bSortable": false, "sClass": "center", "fnRender": function(oObj){
                                return "<td>"+
                                       "<a href='editgroup-"+oObj.aData["Action"]+"' "+
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datagroup_length select, div#datagroup_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
                ...
                jQuery('#groupform').on('submit', function(e){
                    e.preventDefault();
                    if(jQuery('#idgroup').val() === '' || jQuery('#namagroup').val() === '' ){
                        return false;
                    }
                    else{
                            ...
                            success: function(data){
                                if(data === 'true'){
                                    ...
                                    jAlert('Simpan Group Sukses', 'Konfirmasi', function(){
                                        ...
                                        jQuery('#groupform').resetForm();
                                        reloadTabel(datagroup);
                                        No();
                                    });
                                }
                                else if(data === 'false'){
                                    jQuery.gritter.add({
                                        title: 'Group',
                                        text: 'Simpan Group Gagal',
                                        sticky: false,
                                        time: ''
                                    });
                                    $.alerts.dialogClass = 'alert-blue';
                                    jAlert('Simpan Group Gagal', 'Konfirmasi', function(){
                                        $.alerts.dialogClass = null;
                                        No();
                                    });
                                }
