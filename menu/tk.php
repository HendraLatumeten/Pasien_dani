            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Parameter TK</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Parameter TK</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="datatk" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Id TK</th>
            ...
            jQuery(document).ready(function(){
                ...
                datatk = $("#datatk").dataTable({
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datatk_length select, div#datatk_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
