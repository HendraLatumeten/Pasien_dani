...
?>
                        ...
                        <div class="col-md-5">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Entri Data Pekerjaan</h3>
                                </div>
                                <div class="box-body">
                                    <form id="kerjaform" name="kerjaform" role="form" class="form-horizontal"
                                        method="post" action="data/simpanpekerjaan.php?act=new" novalidate="novalidate">
                                        <div class="form-group">
                                            <label for="idkerja" class="col-md-4 control-label">Id Pekerjaan</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control idkerja" id="idkerja" name="idkerja"
                                                    placeholder="Id Pekerjaan" maxlength="2">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="namakerja" class="col-md-4 control-label">Nama Pekerjaan</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="namakerja" name="namakerja"
                        ...
                        <div class="col-md-7">
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="datakerja" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="center" style="width: 10%">No</th>
                                                <th class="center" style="width: 15%">Id Pekerjaan</th>
        ...
        <script>
            ...
            function getdelete(idkerja){
                $.alerts.dialogClass = 'alert-blue';
                $.alerts.okButton = 'Yes';
                $.alerts.cancelButton = 'No';
                jConfirm('Anda yakin menghapusnya ?', 'Konfirmasi', function(r){
                    if(r === true){
                        window.location = 'data/simpanpekerjaan.php?act=delete&id='+idkerja;
                    }
                    else{return false;}
                });
            }
            jQuery(document).ready(function(){
                jQuery('.idkerja').mask('#', {reverse: false});
                function cekid(id){
                    $.ajax({
                        url: "data/cekid.php",
                        type: "POST",
                        data:{id: id, table: 'pekerjaan', field: 'idkerja'},
                ...
                function visible(boolean){
                    if(boolean === true){
                        jQuery('#namakerja').attr('readonly', true);
                    }
                    else{
                        jQuery('#namakerja').removeAttr('readonly');
                    }
                }
                
                jQuery('#idkerja').on('change', function(){
                    cekid(jQuery('#idkerja').val());
                });
                
                var test;
                test = $("#kerjaform").validate({
                    rules:{
                ...
                datakerja = $("#datakerja").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/datapekerjaan.php",
                    "oLanguage": {
                    ...
                    "aoColumns": [
                        ...
                        {"bSortable": false, "sClass": "center", "mData": "idkerja"},
                        {"bSortable": false, "mData": "namakerja"},
                        {"bSortable": false, "sClass": "center", "fnRender": function(oObj){
                                return "<td>"+
                                       "<a href='editpekerjaan-"+oObj.aData["Action"]+"' "+
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datakerja_length select, div#datakerja_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
                ...
                jQuery('#kerjaform').on('submit', function(e){
                    e.preventDefault();
                    if(jQuery('#idkerja').val() === '' || jQuery('#namakerja').val() === '' ){
                        return false;
                    }
                    else{
