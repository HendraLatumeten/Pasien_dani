            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Parameter PAUD</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Parameter PAUD</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="datapaud" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Id PAUD</th>
            ...
            jQuery(document).ready(function(){
                ...
                datapaud = $("#datapaud").dataTable({
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datapaud_length select, div#datapaud_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
