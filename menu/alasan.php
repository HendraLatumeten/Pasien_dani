                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Entri Data Alasan</h3>
                                </div>
                                <div class="box-body">
                                    <form id="alasanform" name="alasanform" role="form" class="form-horizontal"
                                        method="post" action="data/simpanalasan.php?act=new" novalidate="novalidate">
                                        <div class="form-group">
                                            <label for="idalasan" class="col-md-4 control-label">Id Alasan</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="idalasan" name="idalasan"
                                                    placeholder="Id Alasan" readonly value="<?php echo $no?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="namaalasan" class="col-md-4 control-label">Nama Alasan</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="namaalasan" name="namaalasan"
                        ...
                        <div class="col-md-7">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Alasan</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="dataalasan" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="center" style="width: 10%">No</th>
                                                <th class="center" style="width: 15%">Id Alasan</th>
                                                <th style="width: 65%">Nama Alasan</th>
        ...
        <script>
            ...
            function getdelete(idalasan){
                ...
                jConfirm('Anda yakin menghapusnya ?', 'Konfirmasi', function(r){
                    if(r === true){
                        window.location = 'data/simpanalasan.php?act=delete&id='+idalasan;
                    }
                    else{return false;}
                });
            }
            jQuery(document).ready(function(){
                function No(){
                    var idalasan = document.getElementById('idalasan');
                    $.ajax({
                        dataType: 'json',
                        url: "data/maxalasan.php",
                        type: "GET",
                        success: function(data){
                            $.each(data, function(i, n){
                                var alasan1 = n["idalasan"];
                                idalasan.value = alasan1;
                            });
                        },
                        failure: function(){
                ...
                var dataalasan;
                dataalasan = $("#dataalasan").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/dataalasan.php",
                    "oLanguage": {
                    ...
                    "aoColumns": [
                        ...
                        {"bSortable": false, "sClass": "center", "mData": "idalasan"},
                        {"bSortable": false, "mData": "namaalasan"},
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#dataalasan_length select, div#dataalasan_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
                ...
                jQuery('#alasanform').on('submit', function(e){
                    e.preventDefault();
                    if(jQuery('#idalasan').val() === '' || jQuery('#namaalasan').val() === '' ){
                        return false;
                    }
                    else{
