                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Wali Didik</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="datawali" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Id Wali</th>
            ...
            jQuery(document).ready(function(){
                ...
                datawali = $("#datawali").dataTable({
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datawali_length select, div#datawali_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
