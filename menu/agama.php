                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="dataagama" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Id Agama</th>
        ...
        <script>
            jQuery(document).ready(function(){
                ...
                dataagama = $("#dataagama").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/dataagama.php",
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#dataagama_length select, div#dataagama_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
