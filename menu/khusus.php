...
?>
            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Berkebutuhan Khusus</li>
                    </ol>
                </section>
                <section class="content">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Entri Data Berkebutuhan Khusus</h3>
                                </div>
                                <div class="box-body">
                                    <form id="khususform" name="khususform" role="form" class="form-horizontal"
                                        method="post" action="data/simpankhusus.php?act=new" novalidate="novalidate">
                                        <div class="form-group">
                                            <label for="idkhusus" class="col-md-4 control-label">Id Khusus</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="idkhusus" name="idkhusus"
                                                    placeholder="Id Khusus" readonly value="<?php echo $no?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="namakhusus" class="col-md-4 control-label">Nama Khusus</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="namakhusus" name="namakhusus"
                                                    placeholder="Nama Khusus">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="poinkhusus" class="col-md-4 control-label">Point Khusus</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="poinkhusus" name="poinkhusus"
                                                    placeholder="Point Khusus">
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Khusus</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="datakhusus" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="center" style="width: 10%">No</th>
                                                <th class="center" style="width: 15%">Id Khusus</th>
                                                <th style="width: 45%">Nama Khusus</th>
                                                <th style="width: 18%">Point Khusus</th>
        ...
        <script>
            ...
            function getdelete(idkhusus){
                $.alerts.dialogClass = 'alert-blue';
                $.alerts.okButton = 'Yes';
                $.alerts.cancelButton = 'No';
                jConfirm('Anda yakin menghapusnya ?', 'Konfirmasi', function(r){
                    if(r === true){
                        window.location = 'data/simpankhusus.php?act=delete&id='+idkhusus;
                    }
                    else{return false;}
                });
            }
            jQuery(document).ready(function(){
                function No(){
                    var idkhusus = document.getElementById('idkhusus');
                    $.ajax({
                        dataType: 'json',
                        url: "data/maxkhusus.php",
                        type: "GET",
                        success: function(data){
                            $.each(data, function(i, n){
                                var khusus1 = n["idkhusus"];
                                idkhusus.value = khusus1;
                            });
                        },
                        failure: function(){
                ...
                var test;
                test = $("#khususform").validate({
                    rules:{
                        idkhusus:{required : true},
                        namakhusus:{required : true}
                    },
                    messages:{
                        idkhusus:{required: "Id Khusus tidak boleh kosong"},
                        namakhusus:{required: "Nama Khusus tidak boleh kosong"}
                    },
                ...
                var datakhusus;
                datakhusus = $("#datakhusus").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/datakhusus.php",
                    "oLanguage": {
                    ...
                    "aoColumns": [
                        ...
                        {"bSortable": false, "sClass": "center", "mData": "idkhusus"},
                        {"bSortable": false, "mData": "namakhusus"},
                        {"bSortable": false, "mData": "poinkhusus"},
                        {"bSortable": false, "sClass": "center", "fnRender": function(oObj){
                                return "<td>"+
                                       "<a href='editkhusus-"+oObj.aData["Action"]+"' "+
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datakhusus_length select, div#datakhusus_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
                ...
                jQuery('#khususform').on('submit', function(e){
                    e.preventDefault();
                    if(jQuery('#idkhusus').val() === '' || jQuery('#namakhusus').val() === '' ){
                        return false;
                    }
                    else{
                        jQuery(this).ajaxSubmit({
                            success: function(data){
                                if(data === 'true'){
                                    jQuery.gritter.add({
                                        title: 'Khusus',
                                        text: 'Simpan Khusus Sukses',
                                        sticky: false,
                                        time: ''
                                    });
                                    $.alerts.dialogClass = 'alert-blue';
                                    jAlert('Simpan Khusus Sukses', 'Konfirmasi', function(){
                                        $.alerts.dialogClass = null;
                                        jQuery('#khususform').resetForm();
                                        reloadTabel(datakhusus);
                                        No();
                                    });
                                }
                                else if(data === 'false'){
                                    jQuery.gritter.add({
                                        title: 'Khusus',
                                        text: 'Simpan Khusus Gagal',
                                        sticky: false,
                                        time: ''
                                    });
                                    $.alerts.dialogClass = 'alert-blue';
                                    jAlert('Simpan Khusus Gagal', 'Konfirmasi', function(){
                                        $.alerts.dialogClass = null;
                                        No();
                                    });
                                }
