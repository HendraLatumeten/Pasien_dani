...
?>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <table id="datalapdaftar" class="table table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Id Pendaftar</th>
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                //moment().locale()
                var datalapdaftar;
                datalapdaftar = $("#datalapdaftar").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/datalapdaftar.php",
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datalapdaftar_length select, div#datalapdaftar_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
                ...
                function(start, end) {
                    jQuery('#datalapdaftar span').html(start.format('D MMMM YYYY') + ' - ' + end.format('D MMMM YYYY'));
                    jQuery("div.toolbar").html('<b><center>LAPORAN PENDAFTARAN</center></b>'+
                            '<br>'+
                    ...
                    reloadTabel(datalapdaftar);
                });
                jQuery('#datalapdaftar span').html(moment().subtract('days', 29).format('D MMMM YYYY') + ' - ' + moment().format('D MMMM YYYY'));
                jQuery("div.toolbar").html('<b><center>LAPORAN PENDAFTARAN</center></b>'+
                        '<br>'+
