...
?>
            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Warga Negara</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Warga Negara</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="datawarganegara" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Id Warga Negara</th>
        ...
        <script>
            jQuery(document).ready(function(){
                var datawarganegara;
                datawarganegara = $("#datawarganegara").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/datawarganegara.php",
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datawarganegara_length select, div#datawarganegara_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
