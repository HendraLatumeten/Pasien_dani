...
?>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="datakelamin" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Id Kelamin</th>
        ...
        <script>
            jQuery(document).ready(function(){
                var datakelamin;
                datakelamin = $("#datakelamin").dataTable({
                    ...
                    "bProcessing": false,
                    "bServerSide": true,
                    "sAjaxSource": "data/datakelamin.php",
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datakelamin_length select, div#datakelamin_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
