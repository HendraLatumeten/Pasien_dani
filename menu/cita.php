...
?>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Entri Data Cita-Cita</h3>
                                </div>
                                <div class="box-body">
                                    <form id="citaform" name="citaform" role="form" class="form-horizontal"
                                        method="post" action="data/simpancita.php?act=new" novalidate="novalidate">
                                        <div class="form-group">
                                            <label for="idcita" class="col-md-4 control-label">Id Cita</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="idcita" name="idcita"
                                                    placeholder="Id Cita-Cita" value="<?php echo $no?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="namacita" class="col-md-4 control-label">Nama Cita-Cita</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="namacita" name="namacita"
                                                    placeholder="Nama Cita-Cita">
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Cita-Cita</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="datacita" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="center" style="width: 10%">No</th>
                                                <th class="center" style="width: 15%">Id Cita</th>
                                                <th style="width: 65%">Nama Cita-Cita</th>
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                var test;
                test = $("#citaform").validate({
                    rules:{
                        idcita:{required : true},
                        namacita:{required : true}
                    },
                    messages:{
                        idcita:{required: "Id Cita-Cita tidak boleh kosong"},
                        namacita:{required: "Nama Cita-Cita tidak boleh kosong"}
                    },
                ...
                datacita = $("#datacita").dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"bSortable": false, "sClass": "center", "mData": "idcita"},
                        {"bSortable": false, "mData": "namacita"},
                        {"bSortable": false, "sClass": "center", "fnRender": function(oObj){
                                return "<td>"+
                                       "<a href='editcita-"+oObj.aData["Action"]+"' "+
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datacita_length select, div#datacita_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
                ...
                jQuery('#citaform').on('submit', function(e){
                    e.preventDefault();
                    if(jQuery('#idcita').val() === '' || jQuery('#namacita').val() === '' ){
                        return false;
                    }
                    else{
                        jQuery(this).ajaxSubmit({
                            success: function(data){
                                if(data === 'true'){
                                    jQuery.gritter.add({
                                        title: 'Cita-Cita',
                                        text: 'Simpan Cita-Cita Sukses',
                                        sticky: false,
                                        time: ''
                                    });
                                    $.alerts.dialogClass = 'alert-blue';
                                    jAlert('Simpan Cita-Cita Sukses', 'Konfirmasi', function(){
                                        $.alerts.dialogClass = null;
                                        jQuery('#citaform').resetForm();
                                        reloadTabel(datacita);
                                        No();
                                    });
                                }
                                else if(data === 'false'){
                                    jQuery.gritter.add({
                                        title: 'Cita-Cita',
                                        text: 'Simpan Cita-Cita Gagal',
                                        sticky: false,
                                        time: ''
                                    });
                                    $.alerts.dialogClass = 'alert-blue';
                                    jAlert('Simpan Cita-Cita Gagal', 'Konfirmasi', function(){
                                        $.alerts.dialogClass = null;
                                        No();
                                    });
                                }
