                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <p class="help-block small">Hanya nama depan atau nama panggilan</p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
...
?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 help-block">
                                                <label for="keterangan" class="col-md-12 small">Nama User dari Nama Pendaftar & Password dari Kode Pendaftaran</label>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                jQuery('#pendaftaranform').on('submit', function(e){
                    e.preventDefault();
                    //alert(jQuery('#paud1').val()+" "+jQuery('#paud2').val()+' v '+jQuery('[name="paud"]').val());
