...
?>
            ...
            <aside class="right-side">
                <section class="content-header">
                    <h1>
                        Parameter KPS/PKH/KIP
                        <small>Admin SD</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Referensi</a></li>
                        <li class="active">Parameter KPS/PKH/KIP</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Data Parameter KPS/PKH/KIP</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <table id="datakps" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Id KPS</th>
            ...
            jQuery(document).ready(function(){
                ...
                datakps = $("#datakps").dataTable({
                    ...
                    "fnDrawCallback": function( oSettings ){
                        jQuery('div#datakps_length select, div#datakps_filter input').addClass("form-control input-group");
                    },
                    "oTableTools": {
                        "aButtons": [
                            {
